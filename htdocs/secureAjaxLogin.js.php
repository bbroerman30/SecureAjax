...
String.prototype.decodeBase64=function(msg){msg=(typeof msg=="undefined")?false:msg;var b,c,d,e,f,g,h,i,j=[],k,l;l=msg?this.decodeUTF8():this;for(var m=0;m<l.length;m+=4){e=b64.indexOf(l.charAt(m));f=b64.indexOf(l.charAt(m+1));g=b64.indexOf(l.charAt(m+2));h=b64.indexOf(l.charAt(m+3));i=e<<18|f<<12|g<<6|h;b=i>>>16&255;c=i>>>8&255;d=i&255;j[m/4]=String.fromCharCode(b,c,d);if(h==64){j[m/4]=String.fromCharCode(b,c)}if(g==64){j[m/4]=String.fromCharCode(b)}}k=j.join("");return msg?k.decodeUTF8():k};
String.prototype.encodeBase64=function(msg){msg=(typeof msg=="undefined")?false:msg;var b,c,d,e,f,g,h,i,j=[],k="",l,m,n;m=msg?this.encodeUTF8():this;l=m.length%3;if(l>0){while(l++<3){k+="=";m+="\x00"}}for(l=0;l<m.length;l+=3){b=m.charCodeAt(l);c=m.charCodeAt(l+1);d=m.charCodeAt(l+2);e=b<<16|c<<8|d;f=e>>18&63;g=e>>12&63;h=e>>6&63;i=e&63;j[l/3]=b64.charAt(f)+b64.charAt(g)+b64.charAt(h)+b64.charAt(i)}n=j.join("");n=n.slice(0,n.length-k.length)+k;return n};
String.prototype.encodeUTF8=function(){var msg=this.replace(/[\u0080-\u07ff]/g,function(c){var b=c.charCodeAt(0);return String.fromCharCode(192|b>>6,128|b&63)});msg=msg.replace(/[\u0800-\uffff]/g,function(c){var b=c.charCodeAt(0);return String.fromCharCode(224|b>>12,128|b>>6&63,128|b&63)});return msg};
String.prototype.decodeUTF8=function(){var msg=this.replace(/[\u00c0-\u00df][\u0080-\u00bf]/g,function(c){var b=(c.charCodeAt(0)&31)<<6|c.charCodeAt(1)&63;return String.fromCharCode(b)});msg=msg.replace(/[\u00e0-\u00ef][\u0080-\u00bf][\u0080-\u00bf]/g,function(c){var b=((c.charCodeAt(0)&15)<<12)|((c.charCodeAt(1)&63)<<6)|(c.charCodeAt(2)&63);return String.fromCharCode(b)});return msg};var hexcase=0;var chrsz=8;
